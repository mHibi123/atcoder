...
// (URL: https://atcoder.jp/contests/abc464/tasks/abc464_e)
// TypeScript (Bun) Submission [using InputScanner]
// Get-Content contests/abc464/tests/e.in | bun run contests/abc464/e.ts
// ================================================================
...
function Main(inputText: string): void {
    ...
    let grid = Array.from({ length: H }, () => Array.from({ length: W }, () => "A"));
