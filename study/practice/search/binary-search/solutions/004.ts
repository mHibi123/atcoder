// ================================================================
// study/search/binary-search - 004: K 分割の最小の最大和
// (URL: study/practice/search/binary-search/problems/004/problem.md)
// TypeScript (Bun) Submission [using InputScanner]
// Get-Content study/practice/search/binary-search/problems/004/tests/sample.in | bun run study/practice/search/binary-search/solutions/004.ts
// ================================================================
