// ================================================================
// study/search/binary-search - 001: ソート済み配列の存在判定
// (URL: study/practice/search/binary-search/problems/001/problem.md)
...
function Main(inputText: string): void {
    ...
    for (let i = 0; i < Q; i++) {
        const X = scanner.int()!;
        console.log(BinarySearch.binary_search(A, X, (a, b) => a - b) ? "Yes" : "No");
    }
}
