// ================================================================
// study/search/binary-search - 005: K 個選ぶ最小差の最大化
// (URL: study/practice/search/binary-search/problems/005/problem.md)
// TypeScript (Bun) Submission [using InputScanner]
// Get-Content study/practice/search/binary-search/problems/005/tests/sample.in | bun run study/practice/search/binary-search/solutions/005.ts
// ================================================================
