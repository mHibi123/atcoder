// ================================================================
// study/${CATEGORY}/${SLUG} - 001: （問題タイトル）
// (URL: study/practice/${CATEGORY}/${SLUG}/problems/001/problem.md)
// TypeScript (Bun) Submission [using InputScanner]
// Get-Content study/practice/${CATEGORY}/${SLUG}/problems/001/tests/sample.in | bun run study/practice/${CATEGORY}/${SLUG}/solutions/001.ts
// ================================================================
